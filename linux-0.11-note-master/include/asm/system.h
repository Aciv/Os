...
//// 设置门描述符宏函数
// "i" is number, "o"(output) is memory location 
// "a" & "d" to load value to eax, edx before use
...
//// n is a char * pointer
//// rorl count, operand : rotate right , bit to high position
